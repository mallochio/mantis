...
export EXPENSIVE_BASE="$LITELLM_BASE"
export EXPENSIVE_KEY="$LITELLM_KEY"
export EXPENSIVE_MODEL="${EXPENSIVE_MODEL:-gpt-5.6-luna}"
export EXPENSIVE_REASONING_EFFORT="${EXPENSIVE_REASONING_EFFORT:-xhigh}"
export CHEAP_BASE="$LITELLM_BASE"
export CHEAP_KEY="$LITELLM_KEY"
...
export ROUTELLM_CONTEXT_WINDOW="${ROUTELLM_CONTEXT_WINDOW:-1000000}"
