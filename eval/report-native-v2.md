...
- generated at: `2026-08-12T18:58:55.662433+00:00`
...
| conductor-old | 3/16 | 13 | 1.000 | 107.4 | $0.2648 |
| conductor-new | 3/16 | 13 | 0.389 | 109.9 | $0.2298 |
...
| simple | conductor-old | 2/4 | 2 | 1.000 | 179.6 | $0.1765 |
| simple | conductor-new | 2/4 | 2 | 0.333 | 208.7 | $0.1416 |
| medium | direct | 4/4 | 0 | 0.700 | 27.4 | $0.0032 |
| medium | trinity | 4/4 | 0 | 1.000 | 230.6 | $0.2063 |
| medium | conductor-old | 1/4 | 3 | 1.000 | 142.6 | $0.0883 |
...
| hard | conductor-new | 1/4 | 3 | 0.500 | 121.1 | $0.0883 |
| debug | direct | 4/4 | 0 | 0.614 | 29.6 | $0.0032 |
| debug | trinity | 4/4 | 0 | 0.929 | 132.5 | $0.1697 |
| debug | conductor-old | 0/4 | 4 | 0.000 | 0.0 | $0.0000 |
...
- conductor-old mean auto_score (3 successful, 13 errors): 1.000
- conductor-new mean auto_score (3 successful, 13 errors): 0.389
- quality delta: -0.611 (-61.1% vs old)
...
- trinity mean auto_score (16 successful, 0 errors): 0.890
- conductor-new mean auto_score (3 successful, 13 errors): 0.389
- quality delta: -0.501 (-56.3% vs trinity)
- trinity total cost: $0.4563, latency: 1023.0s
- conductor-new total cost: $0.2298, latency: 329.7s
...
- conductor-new: mean auto_score (1 successful, 3 errors) = 0.500, cost = $0.0883

## Recommendation

Conductor-new scores well below direct (0.389 vs 0.568) and fails on 81% of prompts. Recommendation: do not deploy the local Conductor checkpoints as-is; use TRINITY in `/fugu auto` mode, and do not spend more on Conductor training until the checkpoint reliably emits valid DAGs on CPU/float32 serving.
