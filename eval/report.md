...
| conductor-old | 0.052 | 30.7 | $0.1183 |
| conductor-new | 0.062 | 36.9 | $0.1183 |
...
| simple | conductor-old | 0.000 | 131.1 | $0.0000 |
| simple | conductor-new | 0.250 | 207.9 | $0.1183 |
| medium | direct | 0.700 | 27.4 | $0.0032 |
| medium | trinity | 1.000 | 230.6 | $0.2063 |
| medium | conductor-old | 0.000 | 110.7 | $0.0000 |
| medium | conductor-new | 0.000 | 156.9 | $0.0000 |
| hard | direct | 0.000 | 38.7 | $0.0032 |
| hard | trinity | 0.714 | 348.2 | $0.0742 |
| hard | conductor-old | 0.000 | 109.7 | $0.0000 |
| hard | conductor-new | 0.000 | 114.6 | $0.0000 |
| debug | direct | 0.614 | 29.6 | $0.0032 |
| debug | trinity | 0.929 | 132.5 | $0.1697 |
| debug | conductor-old | 0.208 | 139.5 | $0.1183 |
| debug | conductor-new | 0.000 | 111.7 | $0.0000 |
...
- conductor-old mean auto_score: 0.052
- conductor-new mean auto_score: 0.062
- quality delta: +0.010 (+20.0% vs old)
- conductor-old total cost: $0.1183, latency: 491.0s
- conductor-new total cost: $0.1183, latency: 591.2s

### c) conductor-new vs trinity

- trinity mean auto_score: 0.890
- conductor-new mean auto_score: 0.062
- quality delta: -0.827 (-93.0% vs trinity)
- trinity total cost: $0.4563, latency: 1023.0s
- conductor-new total cost: $0.1183, latency: 591.2s
...
- conductor-new: mean auto_score = 0.000, cost = $0.0000

## Recommendation

Conductor-new scores well below direct (0.062 vs 0.568) and fails on 94% of prompts. Recommendation: do not deploy the local Conductor checkpoints as-is; use TRINITY in `/fugu auto` mode, and do not spend more on Conductor training until the checkpoint reliably emits valid DAGs on CPU/float32 serving.
